...
<div class="col">
  ...
  <li class="nav-item">
  <a class="nav-link" href="<?= URL_RAIZ . 'notes'?>">Todos</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active" href="<?= URL_RAIZ . 'notes/minhas'?>">Minhas anotações</a>
  </li>
  <li class="nav-item">
  ...
  foreach ($mensagens as $mensagem) : ?>
	...
	<div class="col pb-4">
        ...
        <h5 class="card-header"><a href="<?= URL_RAIZ . 'notes/' . $mensagem->getId()?>"><i class="fa-solid fa-pen-to-square"></i></a> : <i class="fa-solid fa-trash"></i></h5>
            <div class="card-body">
